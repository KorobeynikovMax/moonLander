...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        arrayList.add(ShapeMatrix.FIRE_DOWN_1);
        arrayList.add(ShapeMatrix.FIRE_DOWN_2);
        arrayList.add(ShapeMatrix.FIRE_DOWN_3);
        downFire = new RocketFire(arrayList);
        ArrayList<int[][]> arrayList1 = new ArrayList();
        arrayList1.add(ShapeMatrix.FIRE_SIDE_1);
        arrayList1.add(ShapeMatrix.FIRE_SIDE_2);
        leftFire = new RocketFire(arrayList1);
        ArrayList<int[][]> arrayList2 = new ArrayList();
        arrayList2.add(ShapeMatrix.FIRE_SIDE_1);
        arrayList2.add(ShapeMatrix.FIRE_SIDE_2);
        rightFire = new RocketFire(arrayList2);
    }
